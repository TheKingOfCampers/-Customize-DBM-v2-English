function iniciarautosave() {
  ...
  if (customizesalvar.value == 0) {
    ...
    document.querySelector("[name='saveatual']").innerText = 'Never';
  }
  if (customizesalvar.value == 1) {
    autosavec = setInterval(saveProject, 30000);
    document.querySelector("[name='saveatual']").innerText = 'Every 30 secondes';
  }
  if (customizesalvar.value == 2) {
    autosavec = setInterval(saveProject, 60000);
    document.querySelector("[name='saveatual']").innerText = 'Every 1 minutes';
  }
  if (customizesalvar.value == 3) {
    autosavec = setInterval(saveProject, 120000);
    document.querySelector("[name='saveatual']").innerText = 'Every  2 minutes';
  }
  if (customizesalvar.value == 4) {
    autosavec = setInterval(saveProject, 300000);
    document.querySelector("[name='saveatual']").innerText = 'Every  5 minutes';
  }
  if (customizesalvar.value == 5) {
    autosavec = setInterval(saveProject, 600000);
    document.querySelector("[name='saveatual']").innerText = 'Every  10 minutes';
  }
  if (customizesalvar.value == 6) {
    autosavec = setInterval(saveProject, 900000);
    document.querySelector("[name='saveatual']").innerText = 'Every  15 minutes';
  }
  if (customizesalvar.value == 7) {
    autosavec = setInterval(saveProject, 1800000);
    document.querySelector("[name='saveatual']").innerText = 'Every  30 minutes';
  }
  if (customizesalvar.value == 8) {
    autosavec = setInterval(saveProject, 2700000);
    document.querySelector("[name='saveatual']").innerText = 'Every  45 minutes';
  }
  if (customizesalvar.value == 9) {
    autosavec = setInterval(saveProject, 3600000);
    document.querySelector("[name='saveatual']").innerText = 'Every  60 minutes';
  }
  if (customizesalvar.value == 10) {
    autosavec = setInterval(saveatukak2, 15000);
    document.querySelector("[name='saveatual']").innerText = 'When to create or edit an action';
  }
}
...
async function attActions() {
	...
	const actionsUrl = "https://api.github.com/repos/TheKingOfCampers/DBM-Mods-English/contents/actions?ref=main";
	const eventsUrl = "https://api.github.com/repos/TheKingOfCampers/DBM-Mods-English/contents/events?ref=main";
